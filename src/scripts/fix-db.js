...
const STATEMENTS = [
  ...
  `CREATE TABLE IF NOT EXISTS "b2b_orders" (
    ...
    "source_pi_id" TEXT REFERENCES "proforma_invoices"("id") ON DELETE SET NULL,
  ...
  `ALTER TABLE "b2b_orders" ADD COLUMN IF NOT EXISTS "source_pi_id" TEXT REFERENCES "proforma_invoices"("id") ON DELETE SET NULL`,
  `CREATE INDEX IF NOT EXISTS "b2b_orders_source_pi_id_idx" ON "b2b_orders"("source_pi_id")`,
  ...
  // ─── MULTI STOCK PURCHASE ORDERS (PO) MODULE ────────────────────────────────
  `CREATE TABLE IF NOT EXISTS "purchase_orders" (
    ...
    "sequence_no"           INTEGER NOT NULL DEFAULT 1,
    "company_entity"        VARCHAR(50) NOT NULL DEFAULT 'PACIFIC_PRODUCTS',
    "company_logo"          VARCHAR(50) NOT NULL DEFAULT 'pacific',
    "supplier_id"           TEXT NOT NULL,
    "branch_id"             TEXT NOT NULL,
  ...
  `CREATE TABLE IF NOT EXISTS "purchase_order_items" (
    ...
    "description"       TEXT,
    "hsn_code"          VARCHAR(50) DEFAULT '8302',
    "quantity"          INTEGER NOT NULL DEFAULT 1,
    ...
    CONSTRAINT "fk_po_items_order" FOREIGN KEY ("purchase_order_id") REFERENCES "purchase_orders"("id") ON DELETE CASCADE ON UPDATE CASCADE
  );`,
  `CREATE INDEX IF NOT EXISTS "idx_po_items_order_id" ON "purchase_order_items"("purchase_order_id");`,
  `CREATE INDEX IF NOT EXISTS "idx_po_items_sku" ON "purchase_order_items"("item_sku");`,
  ...
  `CREATE TABLE IF NOT EXISTS "purchase_order_events" (
    ...
    CONSTRAINT "fk_po_events_order" FOREIGN KEY ("purchase_order_id") REFERENCES "purchase_orders"("id") ON DELETE CASCADE ON UPDATE CASCADE
  );`,
  `CREATE INDEX IF NOT EXISTS "idx_po_events_order_id" ON "purchase_order_events"("purchase_order_id");`,
  ...
  `CREATE TABLE IF NOT EXISTS "purchase_order_dispatches" (
    ...
    CONSTRAINT "fk_po_dispatches_order" FOREIGN KEY ("purchase_order_id") REFERENCES "purchase_orders"("id") ON DELETE CASCADE ON UPDATE CASCADE
  );`,
  `CREATE INDEX IF NOT EXISTS "idx_po_dispatches_order_id" ON "purchase_order_dispatches"("purchase_order_id");`,

  `CREATE TABLE IF NOT EXISTS "purchase_order_sequences" (
    "id"             TEXT NOT NULL,
    "financial_year" VARCHAR(20) NOT NULL,
    "company_entity" VARCHAR(50) NOT NULL,
    "next_number"    INTEGER NOT NULL DEFAULT 1,
    "updated_at"     TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT "purchase_order_sequences_pkey" PRIMARY KEY ("id"),
    CONSTRAINT "uq_po_sequence_fy_entity" UNIQUE ("financial_year", "company_entity")
  );`,

  // ─── PAYMENT FOLLOW-UP & DUES RECOVERY TABLES ──────────────────────────────
  ...
  `CREATE TABLE IF NOT EXISTS "opening_balance_entries" (
    ...
    "reference_note"    TEXT,
    "source_type"       VARCHAR(50) NOT NULL DEFAULT 'OLD_CUSTOMER',
    "status"            VARCHAR(50) NOT NULL DEFAULT 'PENDING',
    "created_by_id"     TEXT,
    "created_at"        TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updated_at"        TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT "opening_balance_entries_pkey" PRIMARY KEY ("id"),
    CONSTRAINT "fk_opening_bal_customer" FOREIGN KEY ("customer_id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE CASCADE
  );`,
  `CREATE INDEX IF NOT EXISTS "idx_opening_bal_customer_id" ON "opening_balance_entries"("customer_id");`,
  `CREATE INDEX IF NOT EXISTS "idx_opening_bal_status" ON "opening_balance_entries"("status");`,
  ...
  `CREATE TABLE IF NOT EXISTS "payment_allocations" (
    ...
    "allocation_mode"        VARCHAR(50) NOT NULL DEFAULT 'OLDEST_DUE_FIRST',
    ...
    CONSTRAINT "fk_pay_alloc_customer" FOREIGN KEY ("customer_id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE CASCADE
  );`,
  `CREATE INDEX IF NOT EXISTS "idx_pay_alloc_customer_id" ON "payment_allocations"("customer_id");`,
  `CREATE INDEX IF NOT EXISTS "idx_pay_alloc_target" ON "payment_allocations"("target_type", "target_id");`,

  `CREATE TABLE IF NOT EXISTS "payment_followup_profiles" (
    "id"                   TEXT NOT NULL,
    "customer_id"          TEXT NOT NULL,
    ...
    "created_at"           TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updated_at"           TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT "payment_followup_profiles_pkey" PRIMARY KEY ("id"),
    CONSTRAINT "uq_pf_profiles_customer_id" UNIQUE ("customer_id"),
    CONSTRAINT "fk_pf_profiles_customer" FOREIGN KEY ("customer_id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE CASCADE
  );`,
  `CREATE INDEX IF NOT EXISTS "idx_pf_profiles_customer_id" ON "payment_followup_profiles"("customer_id");`,
  `CREATE INDEX IF NOT EXISTS "idx_pf_profiles_status" ON "payment_followup_profiles"("status");`,

  `CREATE TABLE IF NOT EXISTS "payment_followup_entries" (
    "id"                     TEXT NOT NULL,
    "customer_id"            TEXT NOT NULL,
    "target_document_id"     TEXT,
    "target_document_number" VARCHAR(255),
    "followup_type"          VARCHAR(50) NOT NULL DEFAULT 'CALL',
    "outcome"                VARCHAR(50) NOT NULL DEFAULT 'CALL_MADE',
    "notes"                  TEXT NOT NULL,
    "ptp_date"               TIMESTAMP(3),
    "ptp_amount"             NUMERIC(14,2),
    "next_action_date"       TIMESTAMP(3),
    ...
    "metadata"               JSONB,
    "created_at"             TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT "payment_followup_entries_pkey" PRIMARY KEY ("id"),
    CONSTRAINT "fk_pf_entries_customer" FOREIGN KEY ("customer_id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE CASCADE
  );`,
  `CREATE INDEX IF NOT EXISTS "idx_pf_entries_customer_id" ON "payment_followup_entries"("customer_id");`,
  `CREATE INDEX IF NOT EXISTS "idx_pf_entries_created_at" ON "payment_followup_entries"("created_at");`,

  `CREATE TABLE IF NOT EXISTS "payment_followup_rules" (
    "id"                   TEXT NOT NULL,
    "name"                 VARCHAR(255) NOT NULL,
    "is_enabled"           BOOLEAN NOT NULL DEFAULT true,
    "aging_threshold_days" INTEGER NOT NULL DEFAULT 7,
    "repeat_interval_days" INTEGER NOT NULL DEFAULT 7,
    "communication_type"   VARCHAR(50) NOT NULL DEFAULT 'EMAIL_LEDGER',
    "max_reminders"        INTEGER NOT NULL DEFAULT 5,
    "template_subject"     TEXT,
    "template_body"        TEXT NOT NULL,
    "created_at"           TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updated_at"           TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT "payment_followup_rules_pkey" PRIMARY KEY ("id")
  );`,

  `CREATE TABLE IF NOT EXISTS "payment_followup_email_logs" (
    "id"                  TEXT NOT NULL,
    "customer_id"         TEXT NOT NULL,
    "recipient_email"     VARCHAR(255) NOT NULL,
    "subject"             TEXT NOT NULL,
    ...
    "dispatched_by_id"    TEXT,
    "created_at"          TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT "payment_followup_email_logs_pkey" PRIMARY KEY ("id"),
    CONSTRAINT "fk_pf_email_logs_customer" FOREIGN KEY ("customer_id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE CASCADE
  );`,
  `CREATE INDEX IF NOT EXISTS "idx_pf_email_logs_customer_id" ON "payment_followup_email_logs"("customer_id");`,

  `CREATE TABLE IF NOT EXISTS "payment_followup_sms_logs" (
    "id"                 TEXT NOT NULL,
    "customer_id"        TEXT NOT NULL,
    ...
    "dispatched_by_id"   TEXT,
    "created_at"         TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT "payment_followup_sms_logs_pkey" PRIMARY KEY ("id"),
