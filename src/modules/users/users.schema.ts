...
export const ListUsersQuerySchema = z.object({
  ...
  type: z.enum(['customer', 'admin', 'b2b', 'all']).optional(),
...
export const CreateUserSchema = z.object({
  ...
  b2bAdvancePercentage: z.coerce.number().min(0).max(100).optional().nullable().default(70),
...
export const UpdateUserSchema = z.object({
  ...
  companyName: z.string().optional(),
  gstin: z.string().max(15).optional().or(z.literal('')),
  b2bAdvancePercentage: z.coerce.number().min(0).max(100).optional().nullable(),
